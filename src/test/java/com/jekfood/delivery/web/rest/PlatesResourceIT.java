...
class PlatesResourceIT {
    ...
    void putExistingPlates() throws Exception {
        ...
        updatedPlates.name(UPDATED_NAME).price(UPDATED_PRICE).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
    ...
    void partialUpdatePlatesWithPatch() throws Exception {
        ...
        partialUpdatedPlates.name(UPDATED_NAME).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
    ...
    void fullUpdatePlatesWithPatch() throws Exception {
        ...
        partialUpdatedPlates.name(UPDATED_NAME).price(UPDATED_PRICE).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
